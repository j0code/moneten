...
execute as @a if score @s moneten_death matches 1.. run scoreboard players remove @s moneten_bank 2000
execute as @a if score @s moneten_death matches 1.. run tellraw @s [{"text":"[","color":"gray"},{"text":"Moneten","color":"gold","hoverEvent":{"action":"show_text","value":"\u00a76Minecraft Moneten\n\u00a7a[✔] \u00a7cMr. Krabs \u00a7aapproved"}},{"text":"]","color":"gray"}," ",{"text":"You died.","color":"gray"}," ",{"text":"2000 Moneten","color":"green"}," ",{"text":"fell out of your purse.","color":"gray"}]
